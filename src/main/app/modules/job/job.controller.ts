...
export class JobController {
  ...
  async updateJob(@Param('id') jobId: string, @Body() body: UpdateJobDto) {
    try {
      ...
      const hasBlogAccountChange = !!body.bloggerAccountId || !!body.wordpressAccountId || !!body.tistoryAccountId
      ...
      if (hasBlogAccountChange) {
        ...
        if (body.bloggerAccountId) {
          accountData.bloggerAccountId = body.bloggerAccountId
          accountData.wordpressAccountId = null
          accountData.tistoryAccountId = null
        } else if (body.wordpressAccountId) {
          accountData.wordpressAccountId = body.wordpressAccountId
          accountData.bloggerAccountId = null
          accountData.tistoryAccountId = null
        } else if (body.tistoryAccountId) {
          accountData.tistoryAccountId = body.tistoryAccountId
          accountData.bloggerAccountId = null
          accountData.wordpressAccountId = null
        }
