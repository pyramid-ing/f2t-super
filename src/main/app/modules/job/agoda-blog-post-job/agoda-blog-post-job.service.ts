...
import {
  AgodaBlogPostJobStatus,
  AgodaBlogPostJobResponse,
  AgodaBlogPost,
  AgodaBlogPostPublish,
} from './agoda-blog-post-job.types'
import { CreateAgodaBlogPostJobDto } from './dto/create-agoda-blog-post-job.dto'
import { UpdateAgodaBlogPostJobDto } from './dto/update-agoda-blog-post-job.dto'
...
리뷰: ${JSON.stringify(agodaProductData.reviews.positive)}`
